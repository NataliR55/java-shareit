...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> getBookingsOfBooker(long bookerId, State state, int from, int size) {
    ...
    public ResponseEntity<Object> getBookingsOfOwner(long ownerId, State state, int from, int size) {
        Map<String, Object> parameters = Map.of(
                "state", state,
                "from", from,
                "size", size
